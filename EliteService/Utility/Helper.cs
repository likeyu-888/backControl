...
namespace EliteService.Utility
{
    public class Helper
    {
        ...
        public static string GetCloudServIp()
        {
            return System.Configuration.ConfigurationManager.AppSettings["cloudServIp"].ToString();
        }

        public static int GetCloudServPort()
        {
            return Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["cloudServPort"].ToString());
        }
